...
#define FP_POPOVER_CONTENT_INSET 10.0
#define FP_POPOVER_ARROW_HEIGHT 12.0
#define FP_POPOVER_ARROW_BASE 17.0
#define FP_POPOVER_RADIUS 9.0
...
-(void)setupViews
{
    ...
    if(_arrowDirection == FPPopoverArrowDirectionUp)
    {
        contentRect.origin = CGPointMake(FP_POPOVER_CONTENT_INSET, FP_POPOVER_ARROW_HEIGHT+FP_POPOVER_CONTENT_INSET);
        contentRect.size = CGSizeMake(self.bounds.size.width-FP_POPOVER_CONTENT_INSET*2, self.bounds.size.height-FP_POPOVER_ARROW_HEIGHT-FP_POPOVER_CONTENT_INSET*2);
    }
    else if(_arrowDirection == FPPopoverArrowDirectionDown)
    {
        contentRect.origin = CGPointMake(FP_POPOVER_CONTENT_INSET, FP_POPOVER_CONTENT_INSET);
        contentRect.size = CGSizeMake(self.bounds.size.width-FP_POPOVER_CONTENT_INSET*2, self.bounds.size.height-FP_POPOVER_ARROW_HEIGHT-FP_POPOVER_CONTENT_INSET*2);
    }
    ...
    {
        contentRect.origin = CGPointMake(FP_POPOVER_CONTENT_INSET, FP_POPOVER_CONTENT_INSET);
        contentRect.size = CGSizeMake(self.bounds.size.width-FP_POPOVER_CONTENT_INSET*2-FP_POPOVER_ARROW_HEIGHT, self.bounds.size.height-FP_POPOVER_CONTENT_INSET*2);
    }
    ...
    {
        contentRect.origin = CGPointMake(FP_POPOVER_CONTENT_INSET, FP_POPOVER_CONTENT_INSET);
        contentRect.size = CGSizeMake(self.bounds.size.width-FP_POPOVER_CONTENT_INSET*2, self.bounds.size.height-FP_POPOVER_CONTENT_INSET*2);
    }
